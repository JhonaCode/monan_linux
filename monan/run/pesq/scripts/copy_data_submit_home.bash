...
path_dire_home="/mnt/beegfs/jhonatan.aguirre/MPAS_project/run_pesq"

#Local to create the submit_home
SUBMIT_HOME=/mnt/beegfs/jhonatan.aguirre/MPAS_project/run_pesq/SUBMIT

#path_prefix_out=`cd ..;pwd`
path_prefix_out=${SUBMIT_HOME}
