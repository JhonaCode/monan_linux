...
function VarEnvironmental() {
    ...
    export path_mets=/home/paulo_kubota/lib/lib_${ESMF_COMPILER}/metis/bin

    export NCARG_ROOT=/home/paulo.kubota/.conda/envs/ncl_stable    
    export NCARG_BIN=${NCARG_ROOT}/bin

    export NCAR_Tools=${SUBMIT_HOME}/pre/sources/${ESMF_COMPILER}/MPAS-Tools
    export NCAR_MPAS=${NCAR_Tools}/MPAS-Limited-Area
    export version_pos=convert_mpas_v0.1.0_egeon.${ESMF_COMPILER}940
    export version_model=MONAN-Model_v1.0.0_egeon.${ESMF_COMPILER}940
    export SLURM='NO'
